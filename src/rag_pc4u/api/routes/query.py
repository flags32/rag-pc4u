...
async def chat_completions(
    ...
    if any(kw in last_question.lower() for kw in keywordsingestsion):
        ...
        artifact_rep = """si vous êtes sûr de vouloir ingérer, appuyez sur le petit bouton :
    ```xml
    <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="24" height="24">
